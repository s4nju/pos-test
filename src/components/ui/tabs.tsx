...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      // "inline-h-9 items-center justify-center p-1 text-muted-foreground",
